...
int main(int argc, char **argv)
{
    ...
    ros::param::param<double>("~rate", rate, 32.0); //Higher than 32 hz causes frames to get missed. Need to figure out why because the ideal value would be 64 for 1 cm resolution. 
